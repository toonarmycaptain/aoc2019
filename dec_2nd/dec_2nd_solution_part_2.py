"""Advent of Code solution December 2nd part 2
...
from dec_2nd.dec_2nd_solution_part_1 import fix_program


def find_solution():
    """
    Find what combination of values at position 1, 2 (noun, verb) in program
    will lead to the value at position 0 being 19690720, then give the result
    of 100*noun + verb.
    """
    for noun in range(100):
        for verb in range(100):
            if fix_program(noun, verb) == 19690720:
